...
Добавить commanding в менюшки

Добавить выделенную букву в Title к элементам меню

Сделать тип меню автоопределяемым в зависимости от наличия дочерних элементов

Обработка клавиш в менюшках - вниз и вверх, ентер, убрать таб

Добавить CLR-событие Invalidated в Control - для того, чтобы делать цепочки из GUI-вызовов, каждый из которых
зависит от результатов размещения контролов, помеченных для Invalidate в предыдущих вызовах.