...
Добавить менеджер размещения - Grid.

Исправить проблему, когда при вызове Invalidate() из другого потока ничего не происходит до
того момента, пока в основной поток не придёт какое-нибудь событие.

Добавить событие в ConsoleApplication - event TerminalSizeChanged с возможностью
обработать его, изменив для root control - canvasSize и usedRect.