...
namespace TestApp
{
	...
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			keypad (stdscr, true);
			start_color ();
			mvaddstr (4, 5, System.Text.Encoding.UTF8.GetBytes("Test string! Русский текст!"));
			refresh ();
		...
		[DllImport("libncursesw.so.5")]
		internal static extern int mvaddstr(int x, int y, [In, MarshalAs(UnmanagedType.LPArray)] byte[] str);
